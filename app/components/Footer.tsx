      ...
      <div className="container mx-auto px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="text-gray-400 mb-4">
            Organisez vos voyages en groupe facilement. Réservez vos destinations, partagez vos avis et
            gérez vos cagnottes en toute simplicité.
          </p>
        ...
        <nav aria-label="Liens rapides" className="space-y-4">
          ...
          <ul className="space-y-2 text-gray-400">
            ...
            <li>
              <a href="/politique-de-confidentialite" className="hover:text-white transition">
...
<div>
  ...
  <div className="flex space-x-4">
    {/* Instagram */}
    <a
      href="https://instagram.com/myless_app"
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Instagram"
      className="w-10 h-10 flex items-center justify-center bg-white rounded-full text-black hover:bg-gray-300 transition"
    >
